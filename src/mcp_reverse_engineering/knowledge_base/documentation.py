...
class ToolDocumentation:
    ...
    def _load_documentation(self) -> None:
        ...
        self.docs = {
            "file": {
                ...
                "examples": ["file binary.exe", "file -b /bin/bash"],
            },
            "strings": {
                "description": "Find printable strings in binary files",
                "usage": "strings [options] file",
                "examples": ["strings -n 5 binary.exe", "strings -t x malware.bin"],
            },
            "hexdump": {
            ...
            "upx": {
                ...
                "examples": ["upx -d packed.exe", "upx --best --lzma binary.exe"],
            },
            "gdb": {
            ...
            "binwalk": {
                ...
                "examples": ["binwalk -e firmware.img", "binwalk -A firmware.img"],
            },
            "unsquashfs": {
            ...
            "ubi_reader": {
                ...
                "examples": ["ubi_reader ubi.img", "ubi_reader -o output_dir ubi.img"],
            },
            "retdc": {
                "description": "Return-oriented decompiler",
                "usage": "retdc [options] file",
                "examples": ["retdc binary.exe", "retdc -o decompiled.c binary.exe"],
            },
            "curl": {
    ...
    def get_tool_docs(self, tool_name: str) -> dict[str, Any]:
        ...
        return self.docs.get(tool_name, {})  # type: ignore[no-any-return]

    def list_documented_tools(self) -> list[str]:
